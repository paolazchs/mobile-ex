      ...
      <View style={styles.card}>
        <View style={styles.avatar}>
          <Text style={styles.avatarText}>
            {(user?.nome || user?.razaoSocial || 'C')[0].toUpperCase()}
          </Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  avatar: {
    ...
    backgroundColor: '#17A2B8', alignItems: 'center', justifyContent: 'center', marginBottom: 16,
  },
  ...
  badge: {
    marginTop: 12, backgroundColor: '#17A2B8',
